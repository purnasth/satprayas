...
const Popup = () => {
  ...
  } = useFetchAPI('popup', `/api/popup.json`);
      ...
      {popup.length > 0 && (
        <AnimatePresence>
          {isOpen && currentIndex < popup.length && (
            ...
            >
              <motion.div
                className="relative mx-auto aspect-square h-auto w-[90%] overflow-hidden rounded-xl bg-white p-0 shadow-lg sm:w-4/5 xl:h-4/5 xl:w-auto"
